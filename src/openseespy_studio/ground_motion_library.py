...
def available_ground_motion_presets(
    *,
    ...
    """Return ground motions that are packaged with Studio and ready offline."""
    return tuple(
        item
...
GROUND_MOTION_LIBRARY: tuple[GroundMotionRecordPreset, ...] = (
    ...
    GroundMotionRecordPreset(
        ...
        notes="Classic benchmark record. Packaged with Studio for offline use.",
        bundled_resource="resources/ground_motions/elCentro_1940_NS.at2",
        collection="Studio Offline Benchmarks",
    ),
    GroundMotionRecordPreset(
        key="northridge-1994-rinaldi",
        label="Northridge 1994 · Rinaldi Receiving Station · 228",
        event="Northridge-01",
        year=1994,
        station="Rinaldi Receiving Station",
        source="PEER / strong-motion archive",
        notes="Near-fault benchmark. Packaged with Studio for offline use.",
        bundled_resource=(
    ...
    GroundMotionRecordPreset(
        key="northridge-1994-arleta-360",
        label="Northridge 1994 · Arleta · 360",
        event="Northridge-01",
        year=1994,
        station="Arleta",
        source="OpenSees example archive / PEER processed record",
        notes="Packaged with Studio for offline research and verification.",
        bundled_resource=(
            "resources/ground_motions/"
            "northridge_1994_arleta_360.at2"
        ),
        collection="Studio Offline Benchmarks",
    ),
    GroundMotionRecordPreset(
        key="chi-chi-1999-nsk-e",
        label="Chi-Chi 1999 · NSK · E",
...
def load_ground_motion_record(
    ...
    """Load a Studio-packaged ground-motion record."""
