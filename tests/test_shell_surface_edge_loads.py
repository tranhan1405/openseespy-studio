...
def test_edge_load_ui_preview_and_generated_nodal_guard_are_exposed():
    ...
    assert "_managed_surface_edge_load_for_nodal_load" in edit_nodal
    assert "owner is not None" in edit_nodal
    assert "_manage_surface_edge_line_load" in edit_nodal
    assert "_managed_surface_edge_load_for_nodal_load" in delete_nodal
    assert "owner is not None" in delete_nodal
    assert "_remove_surface_edge_line_load" in delete_nodal
